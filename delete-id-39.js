// Script pour supprimer l'ID 39 et garder seulement le 36
require('dotenv').config();
const mysql = require('mysql2/promise');

async function deleteId39() {
  let connection;
  try {
    ...
    // Supprimer l'ID 39
    console.log('\n🗑️  SUPPRESSION ID 39 EN COURS...\n');
    const [result] = await connection.query('DELETE FROM users WHERE id = 39');
    ...
    console.log(`📊 Utilisateur restant: ${afterDelete.length}`);
