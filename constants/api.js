...
// En développement local, définissez `API_BASE` ou laissez le fallback sur http://localhost:8082
function resolveApiBase() {
	...
	// 2) If running in a browser, prefer the current host with backend port 8082
